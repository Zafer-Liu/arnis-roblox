...
```bash
rg -n "Automatically migrated to `0.4.0`|backward compatibility|0.3.0 manifest JSON|0.1.0|0.2.0|0.3.0" docs/exporter-fixtures.md docs/chunk_schema.md docs/build-pipeline.md docs/architecture.md docs/remote-studio-development.md docs/superpowers/plans/2026-03-30-outdoor-fidelity-and-source-truth.md docs/superpowers/status/2026-03-30-outdoor-fidelity-and-source-truth-status.md specs/sample-chunk-manifest.json specs/generated rust/crates/arbx_cli/src/main.rs
```
