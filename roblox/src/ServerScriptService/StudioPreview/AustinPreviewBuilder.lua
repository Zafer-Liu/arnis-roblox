...
local function recordSlowChunkSample(phaseName, sample)
    ...
    updatePreviewPerf({
        ...
        SlowChunkBuildingShellDetailMs = math.floor((tonumber(sample.buildingShellDetailMs) or 0) + 0.5),
        SlowChunkBuildingInteriorMs = math.floor((tonumber(sample.buildingInteriorMs) or 0) + 0.5),
        SlowChunkBuildingRoofBuildMs = math.floor((tonumber(sample.buildingRoofBuildMs) or 0) + 0.5),
        SlowChunkBuildingFacadeDetailMs = math.floor((tonumber(sample.buildingFacadeDetailMs) or 0) + 0.5),
        SlowChunkBuildingPerimeterDetailMs = math.floor((tonumber(sample.buildingPerimeterDetailMs) or 0) + 0.5),
        SlowChunkBuildingTerrainFillMs = math.floor((tonumber(sample.buildingTerrainFillMs) or 0) + 0.5),
        SlowChunkBuildingRooftopDetailMs = math.floor((tonumber(sample.buildingRooftopDetailMs) or 0) + 0.5),
        SlowChunkBuildingNameLabelMs = math.floor((tonumber(sample.buildingNameLabelMs) or 0) + 0.5),
        SlowChunkBuildingFeatures = tonumber(sample.buildingFeatureCount) or 0,
        ...
        SlowChunkTerrainCells = tonumber(sample.terrainCellCount) or 0,
        SlowChunkTerrainMaterialKindCount = tonumber(sample.terrainMaterialKindCount) or 0,
        SlowChunkTerrainDominantMaterial = sample.terrainDominantMaterial,
        SlowChunkTerrainDominantMaterialCellCount = tonumber(sample.terrainDominantMaterialCellCount) or 0,
        SlowChunkTerrainNonGrassCellCount = tonumber(sample.terrainNonGrassCellCount) or 0,
        SlowChunkTerrainSubsamples = tonumber(sample.terrainSubsampleCount) or 0,
    ...
    logPreview("slow chunk", {
        ...
        terrainCellCount = tonumber(sample.terrainCellCount) or 0,
        terrainMaterialKindCount = tonumber(sample.terrainMaterialKindCount) or 0,
        terrainDominantMaterial = sample.terrainDominantMaterial,
        terrainDominantMaterialCellCount = tonumber(sample.terrainDominantMaterialCellCount) or 0,
        terrainNonGrassCellCount = tonumber(sample.terrainNonGrassCellCount) or 0,
        terrainSubsampleCount = tonumber(sample.terrainSubsampleCount) or 0,
        ...
        buildingShellDetailMs = math.floor((tonumber(sample.buildingShellDetailMs) or 0) + 0.5),
        buildingInteriorMs = math.floor((tonumber(sample.buildingInteriorMs) or 0) + 0.5),
        buildingRoofBuildMs = math.floor((tonumber(sample.buildingRoofBuildMs) or 0) + 0.5),
        buildingFacadeDetailMs = math.floor((tonumber(sample.buildingFacadeDetailMs) or 0) + 0.5),
        buildingPerimeterDetailMs = math.floor((tonumber(sample.buildingPerimeterDetailMs) or 0) + 0.5),
        buildingTerrainFillMs = math.floor((tonumber(sample.buildingTerrainFillMs) or 0) + 0.5),
        buildingRooftopDetailMs = math.floor((tonumber(sample.buildingRooftopDetailMs) or 0) + 0.5),
        buildingNameLabelMs = math.floor((tonumber(sample.buildingNameLabelMs) or 0) + 0.5),
        buildingFeatureCount = tonumber(sample.buildingFeatureCount) or 0,
